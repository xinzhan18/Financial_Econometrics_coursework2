...
All of models have the same accuracy, which is 87.55\%. But the QDA
model has a lower accuracry which is 86.10\%.
...
some new data and use Random Forest model train this data.
...
\CommentTok{\# train data using Random Forest}
